...
const second_sentence_actions = ["静静地欣赏和鼓励", "严肃的训斥和拍打臀部", "隐藏快速的心跳然后命令之后进行下一步", "想着吃醋的事所以冷淡的安抚", "低声抚慰和温柔亲吻", "心疼的搂住轻抚但继续进行", "诉说爱意并抱住细细品尝", "用正经的语调要求摆出更过分的姿势", "锁住双手然后继续按在膝盖上轻拍", "轻舔嘴唇欣赏着这一幕", "随即站在一旁喘息着故意刺激着她"];
